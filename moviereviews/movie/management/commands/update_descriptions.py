...
# Carga variables del archivo .env (asegurate que la ruta sea correcta)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        instruction = "Reescribe o mejora la descripción de la película de forma atractiva."
        ...
        for movie in movies:
            ...
            break  # Solo actualiza la primera
